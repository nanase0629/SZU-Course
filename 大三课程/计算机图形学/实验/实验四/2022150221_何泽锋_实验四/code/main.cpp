...
void init()
{
	...
	// 设置物体的旋转位移
	table->setTranslation(glm::vec3(-0.75, 0.0, 0.0));
	...
	// 设置物体的旋转位移
	wawa->setTranslation(glm::vec3(0.75, 0.0, 0.0));
...
int main(int argc, char** argv)
{
	...
	// 配置窗口属性
	GLFWwindow* window = glfwCreateWindow(600, 600, u8"2022150221_何泽锋_实验4.1", NULL, NULL);
	if (window == NULL)
	{
