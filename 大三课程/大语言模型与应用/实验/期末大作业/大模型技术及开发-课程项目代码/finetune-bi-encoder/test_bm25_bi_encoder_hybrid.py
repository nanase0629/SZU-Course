...
metrics = {
    ...
    **recall_at,
    **mrr_at,
    'model': f'bm25+bi-encoder-mix({bm25_weight},{bi_weight})-top50-{args.mode}'
}
print('BM25+Bi-encoder top50加权混合指标:', metrics)

# 保存对比结果到result_compare.json
result = {
    'bm25+bi-encoder-hybrid': metrics
}
json_path = 'result_compare.json'
