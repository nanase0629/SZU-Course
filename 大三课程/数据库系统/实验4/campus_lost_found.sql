...
-- Records of 投诉表
-- ----------------------------
INSERT INTO `投诉表` VALUES ('T231201001', 'C231201001', 'U003', '冒领', '该电脑不是该用户的，我有证据证明', NULL, '待处理', '2023-12-01 16:30:00');
INSERT INTO `投诉表` VALUES ('T231203001', 'C231203001', 'U002', '虚假信息', '钱包描述与实际不符', NULL, '待处理', '2023-12-03 14:00:00');
...
INSERT INTO `物品表` VALUES ('L231202001', '学生证', '证件', '计算机学院学生证', '教学楼B区', '2023-12-02 09:15:00', 'U002', NULL, '丢失', 0);
...
INSERT INTO `物品表` VALUES ('L2412051822', '123', '123', '123', '123', '2024-05-06 00:06:00', 'A001', 'U001', '已认领', 1);
...
INSERT INTO `用户登录表` VALUES ('LG241211193516', 'A001', '2024-12-11 19:35:16', '成功');
INSERT INTO `用户登录表` VALUES ('LG241211193540', 'U001', '2024-12-11 19:35:40', '成功');
INSERT INTO `用户登录表` VALUES ('LG241211193555', 'A001', '2024-12-11 19:35:56', '成功');
INSERT INTO `用户登录表` VALUES ('LG241211204509', 'A001', '2024-12-11 20:45:10', '成功');
...
-- Records of 用户表
-- ----------------------------
INSERT INTO `用户表` VALUES ('A001', '张管理', '北京市海淀区', '13800138001', 'admin1@uni.edu', '主楼101', '管理员', 0, 'admin123', 0, NULL);
INSERT INTO `用户表` VALUES ('U001', '李明', '北京市海淀区', '13800138002', 'liming@uni.edu', '宿舍A101', '普通用户', 0, 'user123', 0, NULL);
INSERT INTO `用户表` VALUES ('U002', '王华', '北京市海淀区', '13800138003', 'wanghua@uni.edu', '宿舍B202', '普通用户', 0, 'user123', 0, NULL);
INSERT INTO `用户表` VALUES ('U003', '赵芳', '北京市海淀区', '13800138004', 'zhaofang@uni.edu', '宿舍C303', '普通用户', 0, 'user123', 0, NULL);
INSERT INTO `用户表` VALUES ('U004', '123', '123', '123', '123', '123', '普通用户', 0, '123', 0, NULL);
...
INSERT INTO `认领记录表` VALUES ('C2412111935', 'L2412051822', 'U001', '2024-12-11 19:35:45', '已通过', 0);
...
INSERT INTO `贵重单证表` VALUES ('G2412051822', 'L2412051822', 'A001', '2024-12-05 18:22:41', '\n认领说明：123');

-- ----------------------------
-- View structure for 物品认领视图
-- ----------------------------
DROP VIEW IF EXISTS `物品认领视图`;
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `物品认领视图` AS select `p`.`物品编号` AS `物品编号`,`p`.`物品名称` AS `物品名称`,`p`.`物品类别` AS `物品类别`,`p`.`地点` AS `地点`,`p`.`时间` AS `时间`,`p`.`物品状态` AS `物品状态`,`p`.`是否贵重` AS `是否贵重`,(case when (`c`.`认领编号` is not null) then '已申请认领' else '未申请认领' end) AS `认领状态` from (`物品表` `p` left join `认领记录表` `c` on((`p`.`物品编号` = `c`.`物品编号`)));

-- ----------------------------
-- Procedure structure for 处理认领申请
-- ----------------------------
DROP PROCEDURE IF EXISTS `处理认领申请`;
delimiter ;;
CREATE PROCEDURE `处理认领申请`(IN claim_id CHAR(20),
...
-- ----------------------------
-- Procedure structure for 生成用户编号
-- ----------------------------
...
-- ----------------------------
-- Procedure structure for 申请认领物品
-- ----------------------------
DROP PROCEDURE IF EXISTS `申请认领物品`;
delimiter ;;
CREATE PROCEDURE `申请认领物品`(IN item_id CHAR(20),
...
-- ----------------------------
-- Triggers structure for table 用户表
-- ----------------------------
DROP TRIGGER IF EXISTS `违规次数更新`;
delimiter ;;
CREATE TRIGGER `违规次数更新` AFTER UPDATE ON `用户表` FOR EACH ROW BEGIN
